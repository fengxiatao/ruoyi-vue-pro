...
export enum DICT_TYPE {
  ...
  TRADE_ORDER_ITEM_OPERATE_TYPE = 'trade_order_item_operate_type', // 订单项 - 操作类型 = 'trade_order_item_after_sale_status', // 订单项 - 售后状态
  ...
  CRM_CUSTOMER_LINE = 'crm_customer_line', // CRM 客户线路
